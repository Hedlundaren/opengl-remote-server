...
void Texture::saveTexture(const char * path) {

	int save_result = SOIL_save_image("image_patch.bmp", SOIL_SAVE_TYPE_BMP, width, height, 3 /*rgb*/, image);
	if (save_result) {
		std::cout << "save image complete.\n";
	}
	else {
